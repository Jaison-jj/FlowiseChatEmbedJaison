  ...
  return (
    <>
      ...
      >
        ...
        {props.showTitle ? (
          <div
            class="flex flex-row items-center w-full h-[50px] absolute top-0 left-0 z-10 headerClass"
            style={{
          ...
          >
            ...
            <Show when={props.title}>
              <span class="px-3 whitespace-pre-wrap font-semibold max-w-full text-white text-base">{props.title}</span>
            </Show>
            <div style={{ flex: 1 }} />
            <DeleteButton
